...
<div>
  ...
  <el-tabs type="border-card" style="margin-bottom:260px" v-model="taskSelectedTab">
...
<el-card class="el-card1" style="margin-top:10px" v-if="!procInsId || taskId">
    ...
    activated () {
      ...
      if (this.formType === '2') {
        if (this.formUrl === '/404') {
          ...
          this.$refs.form.init('edit', this.procInsId)
        }
      } else {
      // 读取流程表单
        if (this.formUrl === '/404') {
