...
<div>
    ...
    <el-dialog title="预览" width="70%" height="700px"  :visible.sync="videoVisible">
    ...
    <el-dialog title="预览" width="70%" height="700px" :visible.sync="audioVisible">
      <audio  autoplay  width="100%" :src="url"  controls="controls">'
            Your browser does not support the audio tag.
      </audio>
    </el-dialog>
    <el-dialog title="预览" width="70%" height="700px" :visible.sync="imageVisible">
      <img height="700px" width="100%"  :src="url" />
    </el-dialog>
    <el-dialog title="预览" width="70%" :visible.sync="pdfVisible">
